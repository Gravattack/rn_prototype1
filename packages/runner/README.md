# 🚀 React Native Playground Local Runner

The Local Runner is a companion tool for the React Native Playground. It allows you to run your code on a physical iOS Simulator on your Mac, while you write code in the web-based editor.
